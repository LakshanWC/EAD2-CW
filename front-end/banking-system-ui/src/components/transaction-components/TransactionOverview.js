            ...
            <div style={styles.card}>
                ...
                <div style={styles.servicesGrid}>
                    ...
                    {(!currentUser || currentUser.role !== "ADMIN") && (
                        <>
                            <Link to="/transaction/withdraw" style={styles.serviceCard} className="service-card">
                            ...
                            <Link to="/transaction/deposit" style={styles.serviceCard} className="service-card">
                            ...
                            <Link to="/transaction/transfer" style={styles.serviceCard} className="service-card">
                    ...
                    <Link to="/transaction/history" style={styles.serviceCard} className="service-card">
                    ...
                    {currentUser && currentUser.role === "ADMIN" && (
                        <Link to="/transaction/admin-view" style={styles.serviceCard} className="service-card">
                            ...
                            <h3 style={styles.serviceTitle}>Admin View</h3>
                            <p style={styles.serviceDescription}>View all transactions</p>
                            <div style={styles.serviceArrow}>
                                <svg viewBox="0 0 24 24">
                                    <path fill="#4f46e5" d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" />
                                </svg>
